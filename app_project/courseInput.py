...
generateAddCourse = ctk.CTkButton(
    window,
    text="Add Course")
generateAddCourse.grid(row=3, column=2, padx=5, pady=5, sticky="EW")

# Weekly View button
generateWeeklyView = ctk.CTkButton(
    window,
    text="Weekly View")
generateWeeklyView.grid(row=0, column=0, padx=5, pady=5, sticky="EW")
...
entry.grid(row=2, column=2, padx=5, sticky="EW")
